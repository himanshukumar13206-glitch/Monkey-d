...
# --------------------------------------------------------------
# Helper: trim text with ellipsis to fit a given pixel width
# --------------------------------------------------------------
...
# --------------------------------------------------------------
# Signature text – now "Powered by Avi"
# --------------------------------------------------------------
def _get_signature_text() -> str:
    return "Powered by Avi"
...
class Thumbnail:
    ...
    def _generate_sync(
        ...
        try:
            ...
            panel = Image.new("RGBA", (PANEL_W, PANEL_H), (10, 10, 10, 155))
            ...
            # -------------------------------------------------
            # 🔁 SIGNATURE TEXT IS NOW "Powered by Avi"
            # -------------------------------------------------
            draw.text(
                (45, 22),
                _get_signature_text(),
